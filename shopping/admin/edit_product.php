                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="product_status">
                            ...
                            <option <?php if($row['product_status'] == '2') echo 'selected'; ?> value="2">Sold</option>
                            <option <?php if($row['product_status'] == '3') echo 'selected'; ?> value="3">Unverified</option>
                            <option <?php if($row['product_status'] == '4') echo 'selected'; ?> value="4">Blocked</option>
                        </select>
                    </div>
                    <div class="form-group">
